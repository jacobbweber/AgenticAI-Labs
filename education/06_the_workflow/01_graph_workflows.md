...
The checkpointer script in chapter 05 (`lab2_state_checkpointer.py`) is this graph plus SQLite. This page is the edge and loop, not the INSERT.
...
Walkthrough of lab 2 (same dict as chapter 05, no SQLite):
...
- Chapter 05 checkpointer: [../05_the_state/lab2_state_checkpointer.py](../05_the_state/lab2_state_checkpointer.py) is this graph plus SQLite. This page is the edge, not the INSERT.
