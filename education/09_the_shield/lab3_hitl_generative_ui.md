...
- This script does not POST and does not open a browser. Env defaults still apply to the rest of the chapter: `OLLAMA_HOST` `http://192.168.1.29:11434`, `OLLAMA_MODEL` `qwen3.6:35b-a3b-65k`

## Steps
```mermaid
flowchart TD
    subgraph lab3_hitl_script [lab3_hitl_generative_ui.py]
...
## Stop here
This is not a full React UI. Chapter 10 is the socket that can stream the pause object to a browser. Do not add RBAC or a sandbox in this file. Do not apply a real database migration. The RBAC lab in this folder is a different file also named lab3.
