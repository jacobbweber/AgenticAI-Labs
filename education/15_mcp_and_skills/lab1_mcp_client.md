...
## Stop here
This is not RAG-for-tools and not a skill loader. Do not add a vector search over schemas, a `SKILL.md` read, or a 200-line server. Next: [lab2_skills.md](./lab2_skills.md), then [01_security_overview.md](../16_the_shield/01_security_overview.md).
