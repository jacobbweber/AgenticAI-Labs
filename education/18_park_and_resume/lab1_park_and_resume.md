...
```bash
python education/18_park_and_resume/lab1_park_and_resume.py
```
...
## Notes
- Write `lab1_park_and_resume.py` next to this brief. There is no reference `.py` in the repo yet.
