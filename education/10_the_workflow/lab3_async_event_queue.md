...
```bash
OLLAMA_HOST=http://127.0.0.1:11434 OLLAMA_MODEL=llama3.2:1b python education/10_the_workflow/lab3_async_event_queue.py
```
...
## Stop here
This is not FastAPI. Do not open a port. Do not add Redis, Kafka, or Celery. Next: [00_planning_and_reflection.md](../11_planning_and_reflection/00_planning_and_reflection.md).
...
- Chapter 19 serves these frames over SSE on a real socket.
