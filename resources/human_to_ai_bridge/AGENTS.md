...
- **Active Intent Translation & Guidance**: The AI assistant MUST NOT blindly write simple 1-off scripts. Instead, the AI assistant MUST:
  1. Work with the user and help establish, create and maintain a ./user_vision.md file. The intent of this file is to establish the following:
    ...
    - Problem Statement
    - Goal
  2. Inspect `intent_to_primitive_catalog.md` (or `/resources/human_to_ai_bridge/intent_to_primitive_catalog.md`).
...
- **Proactive Framing Note**: Include a brief framing explanation whenever structural concepts arise:
...
- **Local Ollama Host**: `http://192.168.1.29:11434`
- **Default Model**: `qwen3.6:35b-a3b-65k`
