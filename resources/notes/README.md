...
These pages map marketing words to files, JSON keys, and functions already in the course. They are not labs. Do not write a `.py` here. Read them after chapter 08 (and 16 if you have it). If a page disagrees with a lab brief, the brief wins.
